import { LucideProps, MessageSquare, MessageSquarePlusIcon, Trash2, User } from 'lucide-react'


export const Icons = {
  user: User,
  logo: (props: Omit<React.ImgHTMLAttributes<HTMLImageElement>, keyof LucideProps>) => (
    ...
    //   </g>
    // </svg>
      <img src="/bitslogo.png" className='bg-white' alt="Logo" {...props} />
  ),
